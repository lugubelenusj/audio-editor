...
public class SoundUtil
{
	 ...
	 * @throws javax.sound.sampled.LineUnavailableException if the file cannot be found
	 */
	public static void play(SoundList L) throws LineUnavailableException
	{
	 ...
	 */
	public static SoundLinkedList createSineWave(float time, float frequency, float sampleRate)
	{
	 ...
	 * @return Created MusicList for that sine wave
	 */
	public static SoundLinkedList createSineWave(float time, float frequency, float sampleRate, int numChannels, boolean[] channelsToUse)
	{
		double totalTime = 0;
		SoundLinkedList returnVal = new SoundLinkedList(sampleRate, numChannels);
	 ...
	 */
	public static SoundLinkedList readWAVFile(String filename)
	{
		SoundLinkedList outputMusicList = null;
		...
		try {
			...
			outputMusicList = new SoundLinkedList(audioFormat.getSampleRate(),numChannels);
